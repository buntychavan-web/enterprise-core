...
export const Route = createFileRoute("/_app/reviewer-pending-reviews")({
  head: () => ({
    meta: [{ title: "Reviewer Pending Reviews — EWOS" }, { name: "robots", content: "noindex" }],
  }),
  component: ReviewerPendingReviewsPage,
});
...
function ReviewerPendingReviewsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        title="Reviewer — Pending Reviews"
        description="Appraisals awaiting your independent reviewer assessment."
      />
      ...
      <div className="rounded-lg border border-border bg-card">
        ...
        {loading ? (
          ...
          <EmptyState
            ...
            description="No appraisals are currently awaiting your reviewer assessment."
          />
        ) : (
