...
export const SAMPLE_EMPLOYEE: EmployeeProfile = {
  ...
  documents: [
    ...
    {
      name: "Prev-Experience-Letter.pdf",
      type: "Experience",
      uploadedAt: "2022-03-05",
      status: "Pending",
    },
  ],
  qualifications: [
  ...
  timeline: [
    {
      ...
      description: "Grade updated to L5.",
      tone: "success",
    },
    {
      id: "t2",
    ...
    },
    {
      ...
      description: "Rating: Exceeds expectations.",
      tone: "success",
    },
    {
      id: "t4",
      at: "2024-06-15",
      title: "Transferred to Platform team",
      description: "From Growth Engineering.",
      tone: "neutral",
    },
    {
      id: "t5",
      at: "2022-03-14",
      title: "Joined EWOS",
      description: "Bengaluru HQ, Engineering.",
      tone: "info",
    },
  ],
};
